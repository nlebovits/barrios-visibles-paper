...
This file contains supporting tables and imagery for *Barrios Visibles: Building-footprint evidence of a systematic population undercount in Argentina's informal settlements*. The main article can be read independently and cites this supplement where relevant.
...
## S4 Satellite Imagery

The following author-produced overlays are linked rather than redistributed pending confirmation of the underlying basemap's publication permissions:
...
| 10% | 3,566 | 1,681,066 | 2,352,845 | 5,631,571 | 2.39 |
...
These values divide population by VIV_TOT_P and diagnose occupancy at the aggregate level. Private dwellings may be unoccupied or contain more than one household, so these ratios cannot estimate household size.

| Scope | Radios | Population | Private dwellings | Persons per dwelling |
| --- | ---: | ---: | ---: | ---: |
| National file | 66,502 | 45,618,784 | 17,783,028 | 2.57 |
| All barrio-intersecting radios | 11,421 | 10,817,831 | 3,468,441 | 3.12 |
| Coverage ≥50% | 1,879 | 1,957,589 | 600,606 | 3.26 |
| Coverage ≥75% | 1,210 | 1,245,428 | 383,446 | 3.25 |
| Coverage ≥90% | 881 | 898,425 | 275,769 | 3.26 |
| Coverage ≥95% | 738 | 753,381 | 230,528 | 3.27 |

### S5.3 Multiplier sensitivity at 75% coverage

| Multiplier | Footprint-based population | Allocated Census population | Ratio |
| ---: | ---: | ---: | ---: |
| 2.80 | 1,700,734 | 990,041 | 1.72 |
| 3.12 | 1,895,104 | 990,041 | 1.91 |
| 3.35 | 2,034,807 | 990,041 | 2.06 |

### S5.4 Adjacent-radio diagnostic

The recovered validation pass classified radios with at least 1% barrio coverage, radios within 2 km but below that coverage, and more distant radios. The table reports urban radios only.

| Radio class | Radios | Population | Median population/km² | Persons per private dwelling |
| --- | ---: | ---: | ---: | ---: |
| Contains barrio | 7,695 | 7,795,633 | 8,720 | 3.18 |
| Border, below 1% coverage | 30,285 | 24,342,739 | 11,394 | 2.55 |
| Distant (>2 km) | 20,391 | 12,110,393 | 3,028 | 2.33 |

The saved output shows no elevated persons-per-private-dwelling ratio in adjacent radios. Raw density is higher because adjacent radios cluster in dense urban areas. The result cannot independently confirm that the national Census total is low. The validation output was preserved, but the exact distance-query implementation was not, so this table is not yet fully reproducible from the repository.

### S5.5 Provincial high-coverage comparison

The ≥75% subset is small in several provinces. These diagnostics are not used to make province-specific claims in the article.

| Province | Barrios | Footprints | Allocated Census population | Ratio (×3.35) |
| --- | ---: | ---: | ---: | ---: |
| Neuquén | 12 | 9,106 | 8,950 | 3.41 |
| Chaco | 29 | 23,839 | 24,816 | 3.22 |
| Tierra del Fuego | 13 | 3,779 | 4,186 | 3.02 |
